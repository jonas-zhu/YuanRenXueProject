...
function get_m_t(){
    window = global;
    window.document = {};
    var _0x32a1 = ["data", "GET", "test", "value", "xqGjG", "apply", 'return /" ', ".page-mess", "/16", "GdLcP", "urYGN", "QJoBA", ".number", "toString", "</td>", "active", "DkuHe", "text", "orWXM", "removeClas", "OPLcH", "DFOxl", '+ this + "', "vJCpx", "WcFTW", "url", "dgZjE", "ajax", "page", "VkEce", "因未知原因，数据拉取", "constructo", "json", "parse", "^([^ ]+( +", "each", "^ ]}", "addClass", "append", "生而为虫，我很抱歉", "lqSKe"];
    !function(e) {
        for (; --e; )
            _0x32a1.push(_0x32a1.shift())}(235)
    ...
    !function(e) {
        for (; --e; )
            _0x34e7.push(_0x34e7.shift())}(134)
